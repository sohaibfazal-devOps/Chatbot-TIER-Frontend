...
const EXPERT_ENDPOINTS = {
  treaty: 'https://tr-assistant-v1-api.mammoth-ai.dev/api/v1/query', // Treaty Submission Expert
  claims: 'https://tr-assistant-v1-api.mammoth-ai.dev/api/v1/chatbot-v4', // Claims Expert (you can change this endpoint)
};
